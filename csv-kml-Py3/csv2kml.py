...
def dec_degrees_to_meters(xxx_todo_changeme, xxx_todo_changeme1):
...
#formulas from https://en.wikipedia.org/wiki/Geographic_coordinate_system#Expressing_latitude_and_longitude_as_linear_units
def meters_to_dec_degrees(xxx_todo_changeme2, mean_lat):
...
def get_coords(x, y, xxx_todo_changeme3, xxx_todo_changeme4):
    (dx, dy) = xxx_todo_changeme3
    (xdir, ydir) = xxx_todo_changeme4
